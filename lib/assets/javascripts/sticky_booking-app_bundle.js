...
var angular = __webpack_require__(3);
var templateUrl = __webpack_require__(123);
...
var angular = __webpack_require__(3);
var templateUrl = __webpack_require__(125);
...
angular.module('StickyBooking').factory('occasionSDKService', function () {
    ...
    //Private Functions
    this.queryTimeSlotsByMonth = function (allTimeSlots, month) {
        return new Promise(function (resolve, reject) {

            _this.queryNextTimeSlotsPage(allTimeSlots).then(function (newTimeSlots) {
                ...
                if (new Date(newTimeSlots.__collection[newTimeSlots.__collection.length - 1].startsAt).getMonth() == month) {
                    ...
                    _this.queryTimeSlotsByMonth(newTimeSlots, month).then(function (finalTimeSlots) {
    ...
    this.queryTimeSlotsForProduct = function (product) {
        return new Promise(function (resolve, reject) {
    ...
    this.queryNextTimeSlotsPage = function (timeSlots) {
        return new Promise(function (resolve, reject) {
    ...
    this.queryRedeemableType = function (redeemable) {
        if (redeemable.isA(occsn.Coupon)) return 'coupon';
        if (redeemable.isA(occsn.GiftCard)) return 'card';
    };
    ...
    return {
        ...
        getTimeSlotsByMonth: function getTimeSlotsByMonth(timeSlots, month) {
            return _this.queryTimeSlotsByMonth(timeSlots, month);
        },
